...
export const DriveIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 87.3 78" className={className} fill="currentColor">
    <path d="M6.6 66.85l3.85 6.65c.8 1.4 1.95 2.5 3.3 3.3l13.75-23.8h-27.5c0 1.55.4 3.1 1.2 4.5z" fill="#0066DA"/>
    <path d="M43.65 25l13.75-23.8c-1.35-.8-2.9-1.2-4.5-1.2h-18.5c-1.6 0-3.15.45-4.5 1.2L6.1 25h37.55z" fill="#00AC47"/>
    <path d="M73.55 76.8c1.35-.8 2.5-1.9 3.3-3.3l1.6-2.75 11.1-19.25c.8-1.4 1.2-2.95 1.2-4.5h-27.502l5.852 11.5z" fill="#EA4335"/>
    <path d="M43.65 25L27.5 52.95l-13.75 23.85 19.85.05h18.5l-5.85-11.5z" fill="#00832D"/>
    <path d="M73.55 76.8L59.8 52.95 43.65 25h27.5l13.75 23.8-5.85 11.5z" fill="#2684FC"/>
    <path d="M19.85 52.95l-13.75 23.9 5.85-11.5L27.5 25H6.1z" fill="#FFBA00"/>
  </svg>
);
